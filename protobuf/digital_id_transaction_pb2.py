...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n%protobuf/digital_id_transaction.proto\x1a\x19protobuf/digital_id.proto\x1a\x15protobuf/client.proto\"\xd8\x01\n\x14\x44igitalIdTransaction\x12\x12\n\ndigital_id\x18\x01 \x01(\x0c\x12\x17\n\x0fowner_signature\x18\x02 \x01(\t\x12\x17\n\x06status\x18\x03 \x01(\x0e\x32\x07.Status\x12\x1b\n\x13\x63\x65rtifier_signature\x18\x04 \x01(\t\x12\x16\n\x0ereceiver_group\x18\x05 \x03(\t\x12\x1e\n\x16peer_verification_txns\x18\x06 \x03(\t\x12%\n\nowner_info\x18\x07 \x01(\x0b\x32\x11.ClientAttributesb\x06proto3')
  ,
...
_DIGITALIDTRANSACTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='receiver_group', full_name='DigitalIdTransaction.receiver_group', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='peer_verification_txns', full_name='DigitalIdTransaction.peer_verification_txns', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='owner_info', full_name='DigitalIdTransaction.owner_info', index=6,
...
_DIGITALIDTRANSACTION.fields_by_name['owner_info'].message_type = protobuf_dot_client__pb2._CLIENTATTRIBUTES
